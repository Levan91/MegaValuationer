    ...
    for i in range(0, len(cards), 2):
        ...
        for j, card_id in enumerate(cards[i:i+2]):
            with cols[j]:
                ...
                st.selectbox("Unit No.", options=[""], key=f"unit_no_{card_id}")
                st.selectbox("Development", options=[""], key=f"development_{card_id}")
                st.selectbox("Community", options=[""], key=f"community_{card_id}")
                st.selectbox("Subcommunity", options=[""], key=f"subcommunity_{card_id}")
                st.selectbox("Layout Type", options=[""], key=f"layout_type_{card_id}")
                st.selectbox("Bedrooms", options=[""], key=f"bedrooms_{card_id}")
